"""
The problem is - I'm getting a count instead of the user profile.

https://pypi.org/project/interfolio-api/0.8/
far.get_user(user_id="<id>"): "Retrieve a full profile for the specified user"
"""
...
class InterfolioPublicationRetriever:
    ...
    def get_user_publications(self, user_id):
        try:
            ...
            return None  # So we're gonna return None
